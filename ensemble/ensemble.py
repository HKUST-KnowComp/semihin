...
DIFF_weight = {'[\'sports\', \'automotive\']':0.1,
                  '[\'computer\']':0.2,
                  '[\'medicine\', \'organization\', \'biology\', \'business\']':0.2,
                  '[\'computer\', \'astronomy\', \'spaceflight\', \'automotive\']':0.8,
                  '[\'astronomy\', \'spaceflight\']':0.1
                }

SDM_weight = {'[\'sports\', \'automotive\']':0.1,
                  '[\'computer\']':0.1,
                  '[\'medicine\', \'organization\', \'biology\', \'business\']':0.1,
                  '[\'computer\', \'astronomy\', \'spaceflight\', \'automotive\']':0.1,
                  '[\'astronomy\', \'spaceflight\']':0.1}

def NG20DIFFMetaPaths():
    ...
    #    lp_param = {'alpha':0.98, 'normalization_factor':5}
        ...
        for lp in lp_candidate:
            ssl = SSLClassifier(graph, newLabel, ['rec.autos','comp.os.ms-windows.misc','sci.space'], lp_param, repeatTimes=50, trainNumbers=lp)
...
def NG20DIFFGALEnsemble():
    ...
    for lb in lb_cand:
        ...
        for r in range(repeats):
            ...
            label_file = open('/home/hejiang/results/gal/' + 'DIFF' + '_lb' + str(lb).zfill(3) + '_' +
                              str(r).zfill(3) + '_label.txt', 'w')
            gold_file = open('/home/hejiang/results/gal/' + 'DIFF' + '_lb' + str(lb).zfill(3) + '_' +
                              str(r).zfill(3) + '_gold.txt', 'w')
            eval_file = open('/home/hejiang/results/gal/' + 'DIFF' + '_lb' + str(lb).zfill(3) + '_' +
        ...
        '''
            # os command
#            os.chdir('/home/hejiang/code/get-another-label/bin/')
#            os.system(command)
...
def NG20DIFFCoTrainEnsemble():
    ...
    for rd in range(rounds):
        ...
        #    lp_param = {'alpha':0.98, 'normalization_factor':5}
            ...
            for lb in lb_cand:
                ssl = SSLClassifier(graph, newLabel, ['rec.autos','comp.os.ms-windows.misc','sci.space'], lp_param, repeatTimes=repeats, trainNumbers=lb)
                if rd == 0:
